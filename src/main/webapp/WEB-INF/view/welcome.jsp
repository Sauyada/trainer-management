...
<body>
	...
	<form class="form-horizontal">
		<fieldset>
			...
			<!-- Form Name -->
			<div style="margin-left: 560px" style="margin-bottom: 20px"> <strong>Need to skillup?</strong></div>
			
		<!--   	<div align="center" ><marquee behavior="alternate" onmouseover="stop()" onmouseout="start()" style="color:red;" scrollamount="13" bgcolor="yellow" vspace="10"><b> Passionate about teaching?....</b></marquee> </div>  -->  
		<div>	<b style="margin-left: 580px">Address:</b><p style="color:green; text-align: center;"><b> The Training Academy, Jhansi(UP) India</b></p>
			</div>
